...
from utilsbox.visualops import VisualBook
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='TIME SERIES FORECASTING TEST MODULE')
    ...
    if 'ptac' in identitytag:
        dataloader = PowerTAC(config, 'test')
    else: 
    ...
    databook = network.test(dataloader)
    VisualBook(databook, config, args['algorithm'])